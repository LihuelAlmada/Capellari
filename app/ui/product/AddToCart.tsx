...
const AddToCart = ({ product }: { product: ProductType }) => {
  ...
  return (
    <div>
      ...
      <button
        className="w-full h-12 shadow-sm dark:bg-zinc-50 dark:text-zinc-900 rounded-full py-2 px-3 bg-blue-400 text-center text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
